...
INSERT INTO usuario (nombre, apellido, email, contrasena, fecha_registro, es_admin) VALUES ('admin', 'el poderoso', 'admin@admin.com', '12345', CURRENT_TIMESTAMP, true);
-- Clientes (2-8)
INSERT INTO usuario (nombre, apellido, email, contrasena, fecha_registro, es_admin) VALUES
...
-- Salas (10)
INSERT INTO sala (nombre, filas, columnas) VALUES
('Sala 1', 10, 15),
('Sala 2', 10, 12),
('Sala 3', 12, 18),
('Sala 4', 15, 20),
...
-- Películas (9)
INSERT INTO pelicula (nombre, sinopsis, pagina_oficial, titulo_oficial, genero, nacionalidad, duracion, ano, distribuidora, director, otros_datos, class_edad, portada) VALUES
...
-- Comentarios
INSERT INTO comentario (id_usuario, id_pelicula, texto, fecha_comentario) VALUES
...
-- Reservas
INSERT INTO reserva (id_usuario, fecha_reserva, numero_tarjeta, referencia_reserva, precio) VALUES
...
-- Reserva_Entrada
INSERT INTO reserva_entrada (id_reserva, id_entrada) VALUES
(1, 1), (1, 2),
(2, 9), (2, 10), (2, 11),
(3, 18), (3, 19), (3, 20), (3, 21),
