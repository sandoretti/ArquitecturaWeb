...
<html>
    ...
    <body>
        ...
        //para la conexión a la base de datos y para la
        ...
        %>
        <%
        // Inicialización de las variables necesarias para la conexión 
        //a la base de datos y realización de
        //consultas
        c = DriverManager.getConnection("jdbc:derby:"
                + "//localhost:1527/libros");
        s = c.createStatement();
